"""
Middleware to allow request logging to oslo log for a WSGI application.

Code liberated from Openstack Nova, and intended for use in the OsloLog
Flask Extension.

Original Code:
    https://github.com/openstack/nova/blob/ \
    4f91ed3a547965ed96a22520edcfb783e7936e95/ \
    nova/api/openstack/placement/requestlog.py
"""
